...
% Fix some paragraphs starting with only one line below large figure and then
% the rest is on the next page:
% \clubpenalties nSettings 1.line 2.line 3.line ... nThLineAndTheRest
% FIXME: decide whether this is worth the extra pages
%\clubpenalties 4 10000 10000 1000 0
%\raggedbottom % recommended with club/widowpenalties
...
{%
  ...
  morekeywords={xmlns,version,type,name,msgformat,ttl,interval,callback,description,returnCode,unixTime,dateTime}% list your attributes here
}
...
% ------------------------------------------------------------------
\newcommand{\TITLE}{Smart Home:}
\newcommand{\FTITLE}{Älytalo:}
\newcommand{\STITLE}{Smart byggnad}
\newcommand{\SUBTITLE}{Design and Implementation of IoT-Based Reconfigurable Smart Home System}
\newcommand{\FSUBTITLE}{Esineiden internettiin perustuvan uudelleenkonfiguroitavan älytalojärjestelmän suunnittelu ja toteutus}
\newcommand{\SSUBTITLE}{-}
\newcommand{\DATE}{\today}%February 14, 2020}
\newcommand{\FDATE}{\today}%14. helmikuuta 2020}
\newcommand{\SDATE}{\today}%Den 18 februari 2020}
...
\newcommand{\SUPERVISOR}{Professor Kary Främling}
\newcommand{\FSUPERVISOR}{Professori Kary Främling}
\newcommand{\SSUPERVISOR}{Professor Kary Främling}
...
% If you have two instructors, separate them with \\ to create linefeeds
 \newcommand{\INSTRUCTOR}{Asad Javed M.Sc.\\
  Matti Huotari M.Sc.} % TODO check Mattis title
\newcommand{\FINSTRUCTOR}{Maisteri Asad Javed\\
  Maisteri Matti Huotari}
\newcommand{\SINSTRUCTOR}{Master Asad Javed\\ % TODO: check correct translation for master
  Master Matti Huotari}
...
\newcommand{\KEYWORDS}{Internet of Things, smart home, smart object, peer-to-peer}
\newcommand{\FKEYWORDS}{Esineiden internet, älytalo, älyesine, laitteesta laitteeseen}
\newcommand{\SKEYWORDS}{}
...
\newcommand{\AUTHOR}{Tuomas Keyriläinen}


% FIXME There was warnings that these are already set
...
% references.
%\bibliographystyle{acm} % Problem with authors being abbreviated
...
% ------------------------------------------------------------------
\begin{document}
% XXX: after adding pdfx and new aalto logo generation, something changed the font, change it back to Computer Modern Roman, and set as default
...
%FIXME: I wish to thank my supervisor, professor Kary Främling for introducing me to the field of Internet of Things, in addition to the world of standards and research. Thank you for giving opportunity to learn and experiment freely.
